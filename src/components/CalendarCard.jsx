...
const CalendarCard = ({ date, festival, place }) => {
    return (
        <div className=' flex flex-col md:flex-row items-center justify-between w-full bg-white gap-4 md:gap-0 p-6 md:p-10'>
            ...
            <div>
                <button className='bg-black text-noto font-light tracking-widest uppercase text-lg md:text-xl text-white px-6 py-3 hover:bg-gray-800 hover:cursor-pointer transition-all duration-300'>
                    More information
                </button>
            </div>
