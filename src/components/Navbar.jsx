...
const Navbar = ({abrirMenu, className, bgColor, logo, color, mostrarMenu}) => {
    return (
        <div className=' w-full flex justify-start items-center fixed top-0 left-0 bg-transparent z-40 gap-4'>
            <div className='container mx-auto my-10 px-10 xl:px-0 flex flex-row md:justify-center justify-between items-center w-full h-full gap-0 md:gap-4'>
